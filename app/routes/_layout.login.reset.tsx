...
import { getUserByEmail, updateUserPassword } from '~/lib/models/user'
...
import { ResetFormSchema } from '~/lib/auth/validations'
...
export async function loader({ request }: LoaderArgs) {
	...
	// This checks that user has been redirected from Email.
