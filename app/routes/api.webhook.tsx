...
import { stripe } from '~/lib/stripe/config.server'
import { retrieveStripeSubscription } from '~/lib/stripe/utils'
import {
		...
		case 'checkout.session.completed': {
			...
			if (session.payment_status === 'paid') {
				if (typeof customerId !== 'string' || typeof subscriptionId !== 'string')
					throw new Error('TypeError: Stripe Webhook types are not valid.')
