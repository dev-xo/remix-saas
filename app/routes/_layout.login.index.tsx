	...
	return (
		<div className="flex w-full flex-col">
			...
			<SocialForm provider={SocialsProvider.GOOGLE}>
				<button
					className="relative flex h-14 w-full flex-row items-center justify-center rounded-xl bg-[#4285f4] 
			...
			<SocialForm provider="twitter">
				<button
					className="relative flex h-14 w-full flex-row items-center justify-center rounded-xl bg-[#1da1f2]
					text-base font-bold text-white transition hover:scale-105 hover:brightness-125 active:brightness-90">
					<svg
						className="absolute left-6 h-6 w-6 fill-white"
						viewBox="0 0 24 24"
			...
			<SocialForm provider={SocialsProvider.DISCORD}>
				<button
					className="relative flex h-14 w-full flex-row items-center justify-center rounded-xl bg-[#7289da] 
					text-base font-bold text-white transition hover:scale-105 hover:brightness-125 active:brightness-90">
					<svg
						className="absolute left-6 h-6 w-6 fill-white"
						viewBox="0 0 24 24"
			...
			<SocialForm provider={SocialsProvider.GITHUB}>
				<button
					className="relative flex h-14 w-full flex-row items-center justify-center rounded-xl bg-[#2b3137] 
					text-base font-bold text-white transition hover:scale-105 hover:brightness-125 active:brightness-90">
					<svg
						className="absolute left-6 h-6 w-6 fill-white"
						viewBox="0 0 24 24"
