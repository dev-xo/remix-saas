...
import { getStripePlanValue } from '~/lib/stripe/utils'
...
export function UpdatePlanButton({ planId, purchasedPlanId }: PlanButtonProps) {
	...
	const stripePlanName = getStripePlanValue(planId, 'planName')
	const stripePlanPriceAmount = getStripePlanValue(planId, 'planPriceAmount')
